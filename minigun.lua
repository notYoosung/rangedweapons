...
minetest.register_tool("mcl_rangedweapons:minigun_r", {
	stack_max= 1,
	wield_scale = {x=3.0,y=3.0,z=3.0},
	description = "",
	rw_next_reload = "mcl_rangedweapons:minigun",
	load_sound = "mcl_rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_minigun_rld.png",
})

	minetest.register_tool("mcl_rangedweapons:minigun", {
	stack_max= 1,
	wield_scale = {x=3.0,y=3.0,z=3.0},
...
..core.colorize("#FFFFFF", "Enemy penetration: 33%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 70"),
	range = 0,
	inventory_image = "mcl_rangedweapons_minigun.png",
	RW_gun_capabilities = {
		automatic_gun = 1,
		gun_damage = {fleshy=10,knockback=8},
		gun_crit = 14,
		gun_critEffc = 3.0,
		suitable_ammo = {{"mcl_rangedweapons:762mm",200}},
		gun_skill = {"heavy_skill",100},
		gun_unloaded = "mcl_rangedweapons:minigun_r",
		gun_velocity = 70,
		gun_accuracy = 50,
		gun_cooldown = 0.04,
		gun_reload = 2.0,
