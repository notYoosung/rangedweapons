	...
	minetest.register_tool("mcl_rangedweapons:mp40_r", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:mp40_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	inventory_image = "mcl_rangedweapons_mp40_rld.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("mcl_rangedweapons:mp40_rr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:mp40_rrr",
	load_sound = "mcl_rangedweapons_reload_a",
	inventory_image = "mcl_rangedweapons_mp40.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("mcl_rangedweapons:mp40_rrr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	inventory_image = "mcl_rangedweapons_mp40.png",
	rw_next_reload = "mcl_rangedweapons:mp40",
	load_sound = "mcl_rangedweapons_reload_b",
	groups = {not_in_creative_inventory = 1},
})

	minetest.register_tool("mcl_rangedweapons:mp40", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.5},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 8,
		gun_critEffc = 2.0,
		suitable_ammo = {{"mcl_rangedweapons:9mm",32}},
		gun_skill = {"smg_skill",75},
		gun_magazine = "mcl_rangedweapons:machinepistol_mag",
		gun_unloaded = "mcl_rangedweapons:mp40_r",
		gun_velocity = 25,
		gun_accuracy = 75,
		gun_cooldown = 0.14,
		gun_reload = 1.3/4,
