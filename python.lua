...
minetest.register_tool("mcl_rangedweapons:python_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	description = "",
	loaded_gun = "mcl_rangedweapons:python",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_python_rld.png",
})


minetest.register_tool("mcl_rangedweapons:python", {
...
..core.colorize("#FFFFFF", "penetration: 15%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 55"),
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	inventory_image = "mcl_rangedweapons_python.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=10,knockback=6},
		gun_crit = 19,
		gun_critEffc = 2.2,
		suitable_ammo = {{"mcl_rangedweapons:357",6}},
		gun_skill = {"revolver_skill",40},
		gun_unloaded = "mcl_rangedweapons:python_rld",
		gun_cooling = "mcl_rangedweapons:python",
		gun_velocity = 55,
		gun_accuracy = 95,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
