...
minetest.register_craftitem("mcl_rangedweapons:wooden_shuriken", {
	...
	inventory_image = "mcl_rangedweapons_wooden_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_projectiles = 1,
		throw_gravity = 10,
		throw_sound = "mcl_rangedweapons_throw",
		throw_dps = 0,
		throw_mob_penetration = 0,
		throw_node_penetration = 0,
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:wooden_shuriken",
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:wooden_shuriken") end end,
	},
...
minetest.register_craftitem("mcl_rangedweapons:stone_shuriken", {
	...
	stack_max= 125,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_stone_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:stone_shuriken",
		throw_projectile_size = 0.15,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:stone_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("mcl_rangedweapons:steel_shuriken", {
	...
	stack_max= 150,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_steel_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:steel_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 0,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:steel_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("mcl_rangedweapons:bronze_shuriken", {
		description = "" ..core.colorize("#35cdff","Bronze shuriken\n") ..core.colorize("#FFFFFF", "Ranged damage: 6\n") ..core.colorize("#FFFFFF", "Accuracy: 85%\n") ..core.colorize("#FFFFFF", "knockback: 3\n") ..core.colorize("#FFFFFF", "Critical chance: 8%\n") ..core.colorize("#FFFFFF", "Critical efficiency: 2.2x\n") ..core.colorize("#FFFFFF", "Shuriken survival rate: 30%\n") ..core.colorize("#FFFFFF", "Projectile gravity: 8\n") ..core.colorize("#FFFFFF", "Throwing cooldown: 0.25\n") ..core.colorize("#FFFFFF", "Projectile velocity: 30"),
	range = 0,
	stack_max= 150,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_bronze_shuriken.png",
	RW_throw_capabilities = {
		throw_damage = {fleshy=6,knockback=3},
		throw_crit = 8,
		throw_critEffc = 2.2,
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:bronze_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 0,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:bronze_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("mcl_rangedweapons:golden_shuriken", {
	...
	stack_max= 175,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_golden_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:golden_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:golden_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("mcl_rangedweapons:mese_shuriken", {
	...
	stack_max= 175,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_mese_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:mese_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:mese_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("mcl_rangedweapons:diamond_shuriken", {
	...
	stack_max= 200,
	wield_scale = {x=0.6,y=0.6,z=0.5},
	inventory_image = "mcl_rangedweapons_diamond_shuriken.png",
	RW_throw_capabilities = {
		...
		throw_entity = "mcl_rangedweapons:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "mcl_rangedweapons:diamond_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "mcl_rangedweapons:diamond_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
