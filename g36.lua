...
minetest.register_tool("mcl_rangedweapons:g36_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:g36_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_g36_rld.png",
})

minetest.register_tool("mcl_rangedweapons:g36_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:g36_rrr",
	load_sound = "mcl_rangedweapons_rifle_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_g36.png",
})

minetest.register_tool("mcl_rangedweapons:g36_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:g36",
	...
	minetest.register_tool("mcl_rangedweapons:g36", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
...
..core.colorize("#FFFFFF", "Enemy penetration: 17%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 40"),
	...
	RW_gun_capabilities = {
		...
		gun_crit = 12,
		gun_critEffc = 2.9,
		suitable_ammo = {{"mcl_rangedweapons:556mm",30}},
		gun_skill = {"arifle_skill",55},
		gun_magazine = "mcl_rangedweapons:assaultrifle_mag",
		gun_unloaded = "mcl_rangedweapons:g36_r",
		gun_velocity = 40,
		gun_accuracy = 80,
		gun_cooldown = 0.08,
		gun_reload = 1.2/4,
