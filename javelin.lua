...
minetest.register_craftitem("mcl_rangedweapons:thrown_javelin", {
	wield_scale = {x=2.0,y=2.0,z=1.0},
	inventory_image = "mcl_rangedweapons_thrown_javelin.png",
})

minetest.register_tool("mcl_rangedweapons:javelin", {
	...
	wield_scale = {x=2.0,y=2.0,z=1.0},
	range = 4.5,
	inventory_image = "mcl_rangedweapons_javelin.png",
	tool_capabilities = {
...
RW_throw_capabilities = {
		...
		throw_texture = "mcl_rangedweapons:thrown_javelin",
...
javStack = {name="mcl_rangedweapons:javelin",wear=(bullet.wear)+(65535/throwDur)}
