...
minetest.register_tool("mcl_rangedweapons:uzi_r", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "mcl_rangedweapons:uzi_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_uzi_rld.png",
})
minetest.register_tool("mcl_rangedweapons:uzi_rr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "mcl_rangedweapons:uzi_rrr",
	load_sound = "mcl_rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_uzi.png",
})
minetest.register_tool("mcl_rangedweapons:uzi_rrr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "mcl_rangedweapons:uzi",
...
-------------------------------------------
	...
	minetest.register_tool("mcl_rangedweapons:uzi", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 5,
		gun_critEffc = 1.9,
		suitable_ammo = {{"mcl_rangedweapons:9mm",40},{"mcl_rangedweapons:45acp",22}},
		gun_skill = {"mp_skill",80},
		gun_magazine = "mcl_rangedweapons:machinepistol_mag",
		gun_unloaded = "mcl_rangedweapons:uzi_r",
		gun_velocity = 25,
		gun_accuracy = 72,
		gun_cooldown = 0.08,
		gun_reload = 1.2/4,
