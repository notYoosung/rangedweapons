...
minetest.register_tool("mcl_rangedweapons:taurus_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	description = "",
	loaded_gun = "mcl_rangedweapons:taurus",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_taurus_rld.png",
})


minetest.register_tool("mcl_rangedweapons:taurus", {
...
..core.colorize("#FFFFFF", "penetration: 24%\n") ..core.colorize("#FFFFFF", "Gun type: Revolver\n") ..core.colorize("#FFFFFF", "Bullet velocity: 64"),
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	inventory_image = "mcl_rangedweapons_taurus.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=14,knockback=8},
		gun_crit = 22,
		gun_critEffc = 3.1,
		suitable_ammo = {{"mcl_rangedweapons:44",6}},
		gun_skill = {"revolver_skill",40},
		gun_unloaded = "mcl_rangedweapons:taurus_rld",
		gun_cooling = "mcl_rangedweapons:taurus",
		gun_velocity = 55,
		gun_accuracy = 97,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
