...
minetest.register_tool("mcl_rangedweapons:makarov_rld", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	loaded_gun = "mcl_rangedweapons:makarov",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_makarov_rld.png",
})
minetest.register_tool("mcl_rangedweapons:makarov_r", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:makarov_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_makarov.png",
})

minetest.register_tool("mcl_rangedweapons:makarov_rr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:makarov_rrr",
	load_sound = "mcl_rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_makarov.png",
})

minetest.register_tool("mcl_rangedweapons:makarov_rrr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "mcl_rangedweapons:makarov",
	load_sound = "mcl_rangedweapons_reload_b",
	inventory_image = "mcl_rangedweapons_makarov_rld.png",
})


minetest.register_tool("mcl_rangedweapons:makarov", {
	...
	RW_gun_capabilities = {
		...
		gun_unloaded = "mcl_rangedweapons:makarov_r",
		gun_cooling = "mcl_rangedweapons:makarov_rld",
		gun_velocity = 20,
		gun_accuracy = 90,
		gun_cooldown = 0.5,
		gun_reload = 1.1/4,
