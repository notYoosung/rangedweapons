minetest.register_tool("mcl_rangedweapons:spas12_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "mcl_rangedweapons:spas12",
	loaded_sound = "mcl_rangedweapons_shotgun_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_spas12_rld.png",
})

minetest.register_tool("mcl_rangedweapons:spas12", {
	...
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	inventory_image = "mcl_rangedweapons_spas12.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=3,knockback=7},
		gun_crit = 7,
		gun_critEffc = 2.1,
		suitable_ammo = {{"mcl_rangedweapons:shell",8}},
		gun_skill = {"shotgun_skill",20},
		gun_unloaded = "mcl_rangedweapons:spas12_rld",
		gun_cooling = "mcl_rangedweapons:spas12_uld",
		gun_velocity = 32,
		gun_accuracy = 52,
		gun_cooldown = 0.45,
		gun_gravity = 3,
...
minetest.register_tool("mcl_rangedweapons:spas12_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"mcl_rangedweapons:spas12_rld",0.6,"mcl_rangedweapons_shotgun_reload_a","mcl_rangedweapons:empty_shell")
return itemstack
end,
})
