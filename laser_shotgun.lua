	minetest.register_tool("mcl_rangedweapons:laser_shotgun", {
	stack_max= 1,
	...
	range = 0,
	inventory_image = "mcl_rangedweapons_laser_shotgun.png",
RW_powergun_capabilities = {
		power_damage = {fleshy=10,knockback=0},
		power_crit = 8,
		power_critEffc = 2.2,
		power_skill = {"",1},
		power_cooling = "mcl_rangedweapons:laser_shotgun",
		power_velocity = 55,
		power_accuracy = 40,
		power_cooldown = 0.5,
		power_projectiles = 1,
		...
		power_visual = "sprite",
		power_texture = "mcl_rangedweapons_green_ray.png",
