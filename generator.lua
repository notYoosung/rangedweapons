...
minetest.register_node("mcl_rangedweapons:generator", {
	...
	tiles = {
		"mcl_rangedweapons_generator_top.png",
		"mcl_rangedweapons_generator_bottom.png",
		"mcl_rangedweapons_generator_side.png",
		"mcl_rangedweapons_generator_side.png",
		"mcl_rangedweapons_generator_side.png",
		"mcl_rangedweapons_generator_side.png"
	},
...
inv:add_item("main", "mcl_rangedweapons:power_particle "..nodemeta:get_int("power_generated")) 
