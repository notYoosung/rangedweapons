minetest.register_tool("mcl_rangedweapons:benelli_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "mcl_rangedweapons:benelli",
	loaded_sound = "mcl_rangedweapons_shotgun_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_benelli_rld.png",
})

minetest.register_tool("mcl_rangedweapons:benelli", {
	...
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	inventory_image = "mcl_rangedweapons_benelli.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=2,knockback=6},
		gun_crit = 6,
		gun_critEffc = 2.0,
		suitable_ammo = {{"mcl_rangedweapons:shell",7}},
		gun_skill = {"shotgun_skill",20},
		gun_unloaded = "mcl_rangedweapons:benelli_rld",
		gun_cooling = "mcl_rangedweapons:benelli_uld",
		gun_velocity = 25,
		gun_accuracy = 48,
		gun_cooldown = 0.6,
		gun_gravity = 4,
...
minetest.register_tool("mcl_rangedweapons:benelli_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"mcl_rangedweapons:benelli_rld",0.6,"mcl_rangedweapons_shotgun_reload_a","mcl_rangedweapons:empty_shell")
return itemstack
end,
})
