minetest.register_craftitem("mcl_rangedweapons:blue_ray_visual", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "mcl_rangedweapons_blue_ray.png",
})

	minetest.register_tool("mcl_rangedweapons:laser_blaster", {
	stack_max= 1,
	...
	range = 0,
	inventory_image = "mcl_rangedweapons_laser_blaster.png",
RW_powergun_capabilities = {
		power_damage = {fleshy=15,knockback=0},
		power_crit = 10,
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "mcl_rangedweapons:laser_blaster",
		power_velocity = 65,
		power_accuracy = 100,
		power_cooldown = 0.3,
		power_projectiles = 1,
		...
		power_texture = "mcl_rangedweapons:blue_ray_visual",
