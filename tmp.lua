...
minetest.register_tool("mcl_rangedweapons:tmp_r", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tmp_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_tmp_rld.png",
})

minetest.register_tool("mcl_rangedweapons:tmp_rr", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tmp_rrr",
	load_sound = "mcl_rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_tmp.png",
})

minetest.register_tool("mcl_rangedweapons:tmp_rrr", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tmp",
	load_sound = "mcl_rangedweapons_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_tmp.png",
})

	minetest.register_tool("mcl_rangedweapons:tmp", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 4,
		gun_critEffc = 1.85,
		suitable_ammo = {{"mcl_rangedweapons:9mm",30}},
		gun_skill = {"mp_skill",85},
		gun_magazine = "mcl_rangedweapons:machinepistol_mag",
		gun_unloaded = "mcl_rangedweapons:tmp_r",
		gun_velocity = 20,
		gun_accuracy = 64,
		gun_cooldown = 0.066,
		gun_reload = 1.0/4,
