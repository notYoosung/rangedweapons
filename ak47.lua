...
minetest.register_tool("mcl_rangedweapons:ak47_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:ak47_rr",
	load_sound = "mcl_rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_ak47_rld.png",
})

minetest.register_tool("mcl_rangedweapons:ak47_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:ak47_rrr",
	load_sound = "mcl_rangedweapons_rifle_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_ak47.png",
})

minetest.register_tool("mcl_rangedweapons:ak47_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:ak47",
	...
	minetest.register_tool("mcl_rangedweapons:ak47", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
...
..core.colorize("#FFFFFF", "Enemy penetration: 15%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 40"),
	...
	RW_gun_capabilities = {
		...
		gun_crit = 12,
		gun_critEffc = 2.9,
		suitable_ammo = {{"mcl_rangedweapons:762mm",30}},
		gun_skill = {"arifle_skill",50},
		gun_magazine = "mcl_rangedweapons:assaultrifle_mag",
		gun_unloaded = "mcl_rangedweapons:ak47_r",
		gun_velocity = 40,
		gun_accuracy = 77,
		gun_cooldown = 0.1,
		gun_reload = 1.4/4,
