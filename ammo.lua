...
minetest.register_alias("mcl_rangedweapons:726mm", "mcl_rangedweapons:762mm")

minetest.register_craftitem(
    "mcl_rangedweapons:shot_bullet_visual",
    {
        wield_scale = {x = 1.0, y = 1.0, z = 1.0},
        inventory_image = "mcl_rangedweapons_bulletshot.png"
    }
)
...
local rangedweapons_shot_bullet = {
    ...
    initial_properties = {
        ...
        textures = {"mcl_rangedweapons:shot_bullet_visual"},
        lastpos = {},
...
local use_particles = minetest.settings:get_bool("mcl_rangedweapons_impact_particles", true)
local max_lifetime = tonumber(minetest.settings:get("mcl_rangedweapons_bullet_lifetime")) or 10.0
    ...
    if SBP ~= nil then
        for i = 1, math.random(SBP.amount[1], SBP.amount[2]) do
            minetest.add_particle(
                {
                    pos = {
                        x = self.object:get_pos().x + (math.random(-SBP.pos_randomness, SBP.pos_randomness) / 100),
                        y = self.object:get_pos().y + (math.random(-SBP.pos_randomness, SBP.pos_randomness) / 100),
                        z = self.object:get_pos().z + (math.random(-SBP.pos_randomness, SBP.pos_randomness) / 100)
                    },
                    velocity = {
    ...
    if moveresult.collides == true then
        if moveresult.collisions[1] ~= nil then
            ...
            if moveresult.collisions[1].type == "node" then
                    ...
                    minetest.add_particle(
                        {
                            ...
                            vertical = false,
                            texture = "mcl_rangedweapons_bullethole.png",
                            glow = 0
                        }
                    )
                ...
                if ignite > 0 then
                    if minetest.get_node(moveresult.collisions[1].node_pos).name == "mcl_rangedweapons:barrel" then
                        ...
                        --mcl_explosions.explode(moveresult.collisions[1].node_pos, 3, {drop_chance = 1.0}, self.object)
                    end

                    if minetest.get_node(moveresult.collisions[1].node_pos).name == "mcl_tnt:tnt" then
                        tnt.ignite(minetest.get_node(moveresult.collisions[1].node_pos))
                    end
                end

                if door_break > 0 and minetest.settings:get_bool("mcl_rangedweapons_door_breaking", true) then
                    if string.find(minetest.get_node(moveresult.collisions[1].node_pos).name, "door_wood") then
                        ...
                        minetest.sound_play("mcl_rangedweapons_woodbreak", {pos = moveresult.collisions[1].node_pos})
                    end
                end

                if glass_break > 0 and minetest.settings:get_bool("mcl_rangedweapons_glass_breaking", true) then
                    local nodeName = minetest.get_node(moveresult.collisions[1].node_pos).name

                    if nodeName == "mcl_core:glass" then
                        minetest.swap_node(moveresult.collisions[1].node_pos, {name = "mcl_rangedweapons:broken_glass"})
                    ...
                    if nodeName == "xpanes:pane" or nodeName == "xpanes:pane_flat" then
                        minetest.swap_node(moveresult.collisions[1].node_pos, {name = "air"})
                        minetest.add_item(moveresult.collisions[1].node_pos, "mcl_rangedweapons:glass_shards")
                        minetest.sound_play("glass_break", {pos = moveresult.collisions[1].node_pos})
                    end
                ...
                if minetest.get_item_group(minetest.get_node(moveresult.collisions[1].node_pos).name, "level") > 1 then
                    if minetest.settings:get_bool("mcl_rangedweapons_bullet_ricochet", true) then
                    ...
                    if math.random(1, 100) <= nodePen then
                        ...
                        if
                            minetest.get_item_group(minetest.get_node(moveresult.collisions[1].node_pos).name, "leaves") >
                                0
                         then
                                    ...
                                    minetest.add_particle(
                                        {
                                            ...
                                            vertical = false,
                                            texture = "mcl_rangedweapons_leaf.png",
                                            animation = {
            ...
            if
                moveresult.collisions[1].type == "object" and
                    (not moveresult.collisions[1].object:is_player() or
                        moveresult.collisions[1].object:get_player_name() ~= self.owner)
             then
                ...
                local hit_texture = "mcl_rangedweapons_hit.png"
                ...
                local player_dmg_multiplier =
                    tonumber(minetest.settings:get("mcl_rangedweapons_player_dmg_multiplier")) or 1.0
                local headshot_dmg_multiplier =
                    tonumber(minetest.settings:get("mcl_rangedweapons_headshot_dmg_multiplier")) or 1.75
                local mob_dmg_multiplier = tonumber(minetest.settings:get("mcl_rangedweapons_mob_dmg_multiplier")) or 1.0
                    ...
                    minetest.add_particle(
                        {
                            ...
                            collisiondetection = false,
                            vertical = false,
                            texture = "mcl_rangedweapons_crit.png",
                            glow = 30
                        }
                    )
                    hit_texture = "mcl_rangedweapons_crithit.png"
                end

                moveresult.collisions[1].object:punch(
                    owner,
                    1.0,
                    {
                ...
                local bloodyness = tonumber(minetest.settings:get("mcl_rangedweapons_bloodyness")) or 10
                    ...
                    minetest.add_particle(
                        {
                            ...
                            collisiondetection = true,
                            vertical = false,
                            texture = "mcl_rangedweapons_blood.png",
...
minetest.register_entity("mcl_rangedweapons:shot_bullet", rangedweapons_shot_bullet)
...
minetest.register_craftitem(
    "mcl_rangedweapons:drum_mag",
    {
        wield_scale = {x = 1.0, y = 1.0, z = 1.5},
        inventory_image = "mcl_rangedweapons_drum_mag.png"
    }
)

minetest.register_craftitem(
    "mcl_rangedweapons:handgun_mag_black",
    {
        wield_scale = {x = 0.6, y = 0.6, z = 0.8},
        inventory_image = "mcl_rangedweapons_magazine_handgun.png"
    }
)
local rangedweapons_mag = {
    ...
    textures = {"mcl_rangedweapons:handgun_mag_black"},
    lastpos = {},
...
minetest.register_entity("mcl_rangedweapons:mag", rangedweapons_mag)

minetest.register_craftitem(
    "mcl_rangedweapons:handgun_mag_white",
    {
        wield_scale = {x = 0.6, y = 0.6, z = 0.8},
        inventory_image = "mcl_rangedweapons_handgun_mag_white.png"
    }
)

minetest.register_craftitem(
    "mcl_rangedweapons:machinepistol_mag",
    {
        wield_scale = {x = 0.6, y = 0.6, z = 0.8},
        inventory_image = "mcl_rangedweapons_machinepistol_mag.png"
    }
)

minetest.register_craftitem(
    "mcl_rangedweapons:assaultrifle_mag",
    {
        wield_scale = {x = 0.6, y = 0.6, z = 0.8},
        inventory_image = "mcl_rangedweapons_assaultrifle_mag.png"
    }
)

minetest.register_craftitem(
    "mcl_rangedweapons:rifle_mag",
    {
        wield_scale = {x = 0.6, y = 0.6, z = 0.8},
        inventory_image = "mcl_rangedweapons_rifle_mag.png"
    }
)

minetest.register_craftitem(
    "mcl_rangedweapons:9mm",
    {
        stack_max = 500,
        ...
        inventory_image = "mcl_rangedweapons_9mm.png",
        RW_ammo_capabilities = {
            ...
            ammo_entity = "mcl_rangedweapons:shot_bullet",
            ammo_visual = "wielditem",
            ammo_texture = "mcl_rangedweapons:shot_bullet_visual",
            shell_entity = "mcl_rangedweapons:empty_shell",
            shell_visual = "wielditem",
            shell_texture = "mcl_rangedweapons:shelldrop",
                        ...
                        core.colorize("#FFFFFF", "Bullet crit chance: 2% \n") ..
                            core.colorize("#FFFFFF", "Bullet velocity: 20 \n") ..
                                core.colorize("#FFFFFF", "Bullet knockback: 2 \n") ..
                                    core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_45acp.png",
        RW_ammo_capabilities = {
                    ...
                    core.colorize("#FFFFFF", "Bullet crit efficiency:0.30 \n") ..
                        core.colorize("#FFFFFF", "Bullet velocity: 25 \n") ..
                            core.colorize("#FFFFFF", "Bullet knockback: 1 \n") ..
                                core.colorize("#FFFFFF", "Bullet crit chance: 1% \n") ..
                                    core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_10mm.png",
        RW_ammo_capabilities = {
            ammo_damage = {fleshy = 2, knockback = 1},
            ammo_critEffc = 0.3,
            ammo_crit = 1,
            ...
            shell_entity = "mcl_rangedweapons:empty_shell",
            shell_visual = "wielditem",
            shell_texture = "mcl_rangedweapons:shell_whitedrop",
            ammo_projectile_size = 0.0025,
            has_sparks = 1,
            ignites_explosives = 1
        }
                            ...
                            core.colorize("#FFFFFF", "Bullet knockback: 5 \n") ..
                                core.colorize("#FFFFFF", "Bullet enemy Penetration: 5%\n") ..
                                    core.colorize("#FFFFFF", "Bullet velocity: 45 \n") ..
                                        core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_357.png",
        RW_ammo_capabilities = {
                            ...
                            core.colorize("#FFFFFF", "Bullet knockback: 10 \n") ..
                                core.colorize("#FFFFFF", "Bullet enemy Penetration: 15%\n") ..
                                    core.colorize("#FFFFFF", "Bullet velocity: 55 \n") ..
                                        core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_50ae.png",
        RW_ammo_capabilities = {
                            ...
                            core.colorize("#FFFFFF", "Bullet knockback: 6 \n") ..
                                core.colorize("#FFFFFF", "Bullet enemy Penetration: 6%\n") ..
                                    core.colorize("#FFFFFF", "Bullet velocity: 50 \n") ..
                                        core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_44.png",
        RW_ammo_capabilities = {
                        ...
                        core.colorize("#FFFFFF", "Bullet crit chance: 2% \n") ..
                            core.colorize("#FFFFFF", "Bullet velocity: 40 \n") ..
                                core.colorize("#FFFFFF", "Bullet knockback: 4 \n") ..
                                    core.colorize("#FFFFFF", "Bullet enemy Penetration: 5%\n") ..
                                        core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_762mm.png",
        RW_ammo_capabilities = {
                        ...
                        core.colorize("#FFFFFF", "Bullet crit chance: 2% \n") ..
                            core.colorize("#FFFFFF", "Bullet velocity: 35 \n") ..
                                core.colorize("#FFFFFF", "Bullet knockback: 3 \n") ..
                                    core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_556mm.png",
        RW_ammo_capabilities = {
                                ...
                                core.colorize("#FFFFFF", "Bullet knockback: 4 \n") ..
                                    core.colorize("#FFFFFF", "Bullet gravity: 5 \n") ..
                                        core.colorize("#FFFFFF", "Bullet projectile multiplier: 1.5x\n") ..
                                            core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_shell.png",
        RW_ammo_capabilities = {
            ...
            ammo_entity = "mcl_rangedweapons:shot_bullet",
            ammo_visual = "sprite",
            ammo_texture = "mcl_rangedweapons_buckball.png",
            shell_entity = "mcl_rangedweapons:empty_shell",
            shell_visual = "wielditem",
            shell_texture = "mcl_rangedweapons:shell_shotgundrop",
            ammo_gravity = 5,
...
minetest.register_craftitem(
    "mcl_rangedweapons:308winchester",
    {
        stack_max = 75,
        wield_scale = {x = 0.4, y = 0.4, z = 1.2},
        description = "" ..
                                    ...
                                    core.colorize("#FFFFFF", "Damage gain over 1 sec of flight time: 40 \n") ..
                                        core.colorize("#FFFFFF", "Bullet enemy Penetration: 20%\n") ..
                                            core.colorize("#FFFFFF", "Bullet node Penetration: 10%\n") ..
                                                core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_308winchester.png",
        RW_ammo_capabilities = {
            ammo_damage = {fleshy = 8, knockback = 10},
            ammo_critEffc = 0.75,
            ammo_crit = 2,
                                    ...
                                    core.colorize("#FFFFFF", "Damage gain over 1 sec of flight time: 80 \n") ..
                                        core.colorize("#FFFFFF", "Bullet enemy Penetration: 45%\n") ..
                                            core.colorize("#FFFFFF", "Bullet node Penetration: 20%\n") ..
                                                core.colorize("#FFFFFF", "Ammunition for some guns"),
        inventory_image = "mcl_rangedweapons_408cheytac.png",
        RW_ammo_capabilities = {
...
minetest.register_craftitem(
    "mcl_rangedweapons:40mm",
    {
        ...
        description = "" ..
            core.colorize("#35cdff", ".40mm grenade\n") ..
                core.colorize("#FFFFFF", "Bullet damage: 10 \n") ..
        ...
        inventory_image = "mcl_rangedweapons_40mm.png",
        RW_ammo_capabilities = {
            ammo_damage = {fleshy = 10, knockback = 15},
            ammo_critEffc = 1.0,
            ammo_crit = 1,
            ...
            ammo_entity = "mcl_rangedweapons:shot_bullet",
            ammo_visual = "sprite",
            ammo_texture = "mcl_rangedweapons_rocket_fly.png",
            shell_entity = "mcl_rangedweapons:empty_shell",
            shell_visual = "wielditem",
            shell_texture = "mcl_rangedweapons:shell_grenadedrop",
            ammo_projectile_size = 0.15,
            has_sparks = 1,
            ammo_gravity = 5,
            ignites_explosives = 1,
            OnCollision = function(player, bullet, target)
                mcl_explosions.explode(bullet.object:get_pos(), 2, {drop_chance = 1.0}, bullet.object)
            end,
            ammo_particles = {
...
minetest.register_craftitem(
    "mcl_rangedweapons:rocket",
    {
        stack_max = 15,
        wield_scale = {x = 1.2, y = 1.2, z = 2.4},
        description = "" ..
            core.colorize("#35cdff", "rocket\n") ..
        ...
        inventory_image = "mcl_rangedweapons_rocket.png",
        RW_ammo_capabilities = {
            ...
            ignites_explosives = 1,
            OnCollision = function(player, bullet, target)
                mcl_explosions.explode(bullet.object:get_pos(), 3, {drop_chance = 1.0}, bullet.object)
            end,
            ammo_particles = {
                velocity = {x = 1, y = 1, z = 1},
                acceleration = {x = 1, y = 1, z = 1},
