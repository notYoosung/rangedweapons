...
minetest.register_tool("mcl_rangedweapons:m16_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:m16_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_m16_rld.png",
})

minetest.register_tool("mcl_rangedweapons:m16_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:m16_rrr",
	load_sound = "mcl_rangedweapons_rifle_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_m16.png",
})

minetest.register_tool("mcl_rangedweapons:m16_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "mcl_rangedweapons:m16",
	...
	minetest.register_tool("mcl_rangedweapons:m16", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
...
..core.colorize("#FFFFFF", "Enemy penetration: 10%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 35"),
	...
	RW_gun_capabilities = {
		...
		gun_crit = 11,
		gun_critEffc = 2.75,
		suitable_ammo = {{"mcl_rangedweapons:556mm",20}},
		gun_skill = {"arifle_skill",55},
		gun_magazine = "mcl_rangedweapons:assaultrifle_mag",
		gun_unloaded = "mcl_rangedweapons:m16_r",
		gun_velocity = 35,
		gun_accuracy = 75,
		gun_cooldown = 0.067,
		gun_reload = 1.0/4,
