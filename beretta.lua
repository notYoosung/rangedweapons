...
minetest.register_tool("mcl_rangedweapons:beretta_rld", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	range = 0,
	loaded_gun = "mcl_rangedweapons:beretta",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_beretta_rld.png",
})
minetest.register_tool("mcl_rangedweapons:beretta_r", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "mcl_rangedweapons:beretta",
...
minetest.register_tool("mcl_rangedweapons:beretta", {
	...
	wield_scale = {x=1.1,y=1.1,z=1.05},
	range = 0,
	inventory_image = "mcl_rangedweapons_beretta.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=4,knockback=4},
		gun_crit = 15,
		gun_critEffc = 2.1,
		suitable_ammo = {{"mcl_rangedweapons:9mm",15}},
		gun_skill = {"handgun_skill",43},
		gun_magazine = "mcl_rangedweapons:handgun_mag_black",
		gun_unloaded = "mcl_rangedweapons:beretta_r",
		gun_cooling = "mcl_rangedweapons:beretta_rld",
		gun_velocity = 25,
		gun_accuracy = 94,
		gun_cooldown = 0.4,
		gun_reload = 0.5,
