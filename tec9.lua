...
minetest.register_craftitem("mcl_rangedweapons:tec9_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tec9_rr",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_tec9_rld.png",
})

minetest.register_craftitem("mcl_rangedweapons:tec9_rr", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tec9_rrr",
	load_sound = "mcl_rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_tec9.png",
})

minetest.register_craftitem("mcl_rangedweapons:tec9_rrr", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:tec9",
	...
	minetest.register_craftitem("mcl_rangedweapons:tec9", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 9,
		gun_critEffc = 1.9,
		suitable_ammo = {{"mcl_rangedweapons:9mm",50}},
		gun_skill = {"mp_skill",80},
		gun_magazine = "mcl_rangedweapons:machinepistol_mag",
		gun_unloaded = "mcl_rangedweapons:tec9_r",
		gun_velocity = 20,
		gun_accuracy = 75,
		gun_cooldown = 0.2,
		gun_reload = 1.0/4,
