...
minetest.register_tool("mcl_rangedweapons:deagle_rld", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	loaded_gun = "mcl_rangedweapons:deagle",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_deagle_rld.png",
})
minetest.register_tool("mcl_rangedweapons:deagle_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:deagle",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_deagle_rld.png",
})

minetest.register_tool("mcl_rangedweapons:deagle", {
...
..core.colorize("#FFFFFF", "penetration: 15%\n")..core.colorize("#FFFFFF", "Bullet velocity: 50"),
	wield_scale = {x=1.25,y=1.25,z=1.5},
	range = 0,
	inventory_image = "mcl_rangedweapons_deagle.png",
RW_gun_capabilities = {
		gun_damage = {fleshy=11,knockback=6},
		gun_crit = 20,
		gun_critEffc = 2.2,
		suitable_ammo = {{"mcl_rangedweapons:357",9},{"mcl_rangedweapons:44",8},{"mcl_rangedweapons:50ae",7}},
		gun_skill = {"revolver_skill",40},
		gun_magazine = "mcl_rangedweapons:handgun_mag_white",
		gun_unloaded = "mcl_rangedweapons:deagle_r",
		gun_cooling = "mcl_rangedweapons:deagle_rld",
		gun_velocity = 50,
		gun_accuracy = 85,
		gun_cooldown = 0.7,
		gun_reload = 0.6/1,
		...
		gun_sound = "mcl_rangedweapons_deagle",
	},
...
minetest.register_tool("mcl_rangedweapons:golden_deagle_rld", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	loaded_gun = "mcl_rangedweapons:golden_deagle",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_golden_deagle_rld.png",
})
minetest.register_tool("mcl_rangedweapons:golden_deagle_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "mcl_rangedweapons:golden_deagle",
	load_sound = "mcl_rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "mcl_rangedweapons_golden_deagle_rld.png",
})

minetest.register_tool("mcl_rangedweapons:golden_deagle", {
...
..core.colorize("#FFFFFF", "penetration: 15%\n")..core.colorize("#FFFFFF", "Bullet velocity: 50"),
	wield_scale = {x=1.25,y=1.25,z=1.5},
	range = 0,
	inventory_image = "mcl_rangedweapons_golden_deagle.png",
RW_gun_capabilities = {
		...
		gun_magazine = "mcl_rangedweapons:handgun_mag_white",
		gun_unloaded = "mcl_rangedweapons:golden_deagle_r",
		gun_cooling = "mcl_rangedweapons:golden_deagle_rld",
		gun_velocity = 50,
		gun_accuracy = 90,
		gun_cooldown = 0.75,
		gun_reload = 0.6/1,
